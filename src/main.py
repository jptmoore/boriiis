...
@click.option("--lang", type=click.Choice(['eng', 'fra', 'deu']), show_default=True, default=config_ini.get("tesseract", "LANG"), help="Current languages supported.")
...
@click.option("--oem", show_default=True, default=int(config_ini.get("tesseract", "OEM")), help="Tesseract engine mode.")
@click.option("--psm", show_default=True, default=int(config_ini.get("tesseract", "PSM")), help="Tesseract page segmentation mode.")
